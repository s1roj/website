<template>
  <div class="bg-[#EAEAEA]">
    <div class="mx-auto max-w-[1920px]">
      <div class="main pb-[220px] mb-[170px]">
        <div class="container mx-auto py-5">
          <div class="header flex justify-between items-center mb-[160px]">
            <div class="left-side">
              <ul class="flex gap-[40px] text-2xl">
                <li>Home</li>
                <li>About Us</li>
              </ul>
            </div>
            <h1 class="title text-4xl font-semibold">
      ...
      <div class="section container mx-auto mb-[170px]">
        ...
        <div class="statistic grid grid-cols-10">
          <div class="pr-[75px] col-span-4">
      ...
      <div class="course mx-auto container mb-[170px]">
        ...
        <div class="flex flex-wrap gap-[54px]">
          <div
            ...
            <div>
              <h3 class="font-semibold text-[32px]">Engineering</h3>
              <p class="text-[16px]">
          ...
          <div
            ...
            <div>
              <h3 class="font-semibold text-[32px]">Psychology</h3>
              <p class="text-[16px]">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </p>
            </div>
          ...
          <div
            ...
            <div>
              <h3 class="font-semibold text-[32px]">Fine Arts</h3>
              <p class="text-[16px]">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </p>
            </div>
          ...
          <div
            ...
            <div>
              <h3 class="font-semibold text-[32px]">Language</h3>
              <p class="text-[16px]">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </p>
            </div>
          ...
          <div
            ...
            <div>
              <h3 class="font-semibold text-[32px]">Accountancy</h3>
              <p class="text-[16px]">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </p>
            </div>
          ...
          <div
            ...
            <div>
              <h3 class="font-semibold text-[32px]">Science</h3>
              <p class="text-[16px]">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
              </p>
            </div>
